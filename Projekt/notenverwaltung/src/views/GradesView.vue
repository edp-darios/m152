    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="form-group w-100">
          <input v-model="newSubject" type="text" placeholder="Subject" aria-label="New Subject" aria-describedby="add-button" class="form-control">
          ...
          <input v-model="newGrade" type="text" placeholder="Grade" aria-label="New Grade" aria-describedby="add-button" class="form-control">
